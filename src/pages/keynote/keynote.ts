...
export class KeynotePage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private modal : ModalController) {
	...
	{"name": "Vivian Krause", "t" : "Contributor to the Financial Post","time":"2:15 pm Monday", "place": " BALLROOM B", "src": "../../assets/imgs/vivian.jpg", "bio": "Speaker Bio coming soon." }
	];
